    ...
    <div className={styles.project} id="project">
      ...
      <div className={styles.project_main}>
        ...
        <div className={styles.project_each}>
          ...
          <p className={styles.project_desc}>
            Single Landing web page to showcase product information
          </p>
          <p className={styles.project_title}>Technologies</p>
          <div className={styles.project_icons}>
            <li>
          ...
          <Link href="https://business-project.netlify.app/" passHref>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://business-project.netlify.app/"
            >
              <button className={styles.project_btn}>View Project</button>
            </a>
          </Link>
        ...
        <div className={styles.project_each}>
          ...
          <Link href="https://upbeat-shannon-25ad23.netlify.app/" passHref>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://upbeat-shannon-25ad23.netlify.app/"
            >
              <button className={styles.project_btn}>View Project</button>
            </a>
          </Link>
